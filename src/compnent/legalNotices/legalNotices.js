                        ...
                        <div className="card card-outline-secondary shadow-lg bg-white rounded">
                            ...
                            <div className="card-body">
                                <div>
                                    ...
                                    <p className="text-justify"><strong>Adresse : </strong>adresse, Adresse</p>
                                    <p className="text-justify"><strong>Propriétaire :</strong> Nom du Propriétaire </p>
                                    <p className="text-justify"><strong>Responsable de publication :</strong> Nom du responsable de publication </p>
                                    <p className="text-justify"><strong>Conception et réalisation :</strong> noms des personnes</p>
                                    <p className="text-justify"><strong>Hébergement :</strong> Nom de l'hébergeur</p>
